...
temperature_BMP280 = []      # List that contains the temperature         
pressure_BMP280 = []         # List that contains the pressure 
...
while True: 
    ...
    temp_BMP280 = float(dataArray[1])            #Convert second element to floating number 
    P_BMP280 =    float(dataArray[2])            #Convert third element to floating number 
    temperature_LM35.append(temp_LM35)           #Build our temperature_LM35 array by appending temperatures readings 
    temperature_BMP280.append(temp_BMP280)       #Build our temperature_BMP280 array by appending temperatures readings
    pressure_BMP280.append(P_BMP280)             #Build our temperature_BMP280 array by appending pressuress readings
